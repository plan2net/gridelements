 ...
 */
class GridelementsBackendLayoutIconUpdateWizard implements UpgradeWizardInterface, ChattyInterface, LoggerAwareInterface
{
     ...
     * @var string
     */
    protected string $fieldToMigrate = 'icon';
    ...
    {
        return 'gridelementsBackendLayoutIcon';
    }
    ...
    {
        return 'Migrate all file relations from tx_gridelements_backend_layout.icon to sys_file_references';
    }
    ...
    public function getDescription(): string
    {
        return 'This update wizard goes through all files that are referenced in the'
            . ' tx_gridelements_backend_layout.icon field and adds the files to the FAL File Index.'
