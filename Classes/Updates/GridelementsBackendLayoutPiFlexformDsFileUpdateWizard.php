 ...
 */
class GridelementsBackendLayoutPiFlexformDsFileUpdateWizard implements UpgradeWizardInterface, ChattyInterface, LoggerAwareInterface
{
    ...
    {
        return 'gridelementsBackendLayoutPiFlexformDsFile';
    }
    ...
    {
        return 'Migrate all file relations from tx_gridelements_backend_layout.pi_flexform_ds_file to sys_file_references';
    }
    ...
    public function getDescription(): string
    {
        return 'This update wizard goes through all files that are referenced in the'
            . ' tx_gridelements_backend_layout.pi_flexform_ds_file field and adds the files to the FAL File Index.'
